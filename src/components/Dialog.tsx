  ...
  return (
    <DialogPrimitive.Root>
      <DialogPrimitive.Trigger asChild>
        <button className='flex flex-col items-center px-6 py-2 border border-black'>
          <ChevronUpIcon />
          <p>Index</p>
        </button>
      ...
      <DialogPrimitive.Portal className='xs:w-full'>
        ...
        <DialogPrimitive.Content className='xs:flex xs:flex-col items-center xs:w-full absolute bottom-0 left-2/4 -translate-x-2/4'>
          ...
          <DialogPrimitive.Close asChild>
            <button className='flex flex-col items-center absolute bottom-4 px-6 py-2 bg-black text-white '>
              <ChevronDownIcon />
              <p>Index</p>
            </button>
