      ...
      {isClient ? (
        <DialogPrimitive.Root open={open} onOpenChange={setOpen}>
          <DialogPrimitive.Trigger asChild>
            <button className='flex flex-col items-center mx-auto px-6 py-2 border border-black group'>
          ...
          <DialogPrimitive.Portal className=''>
            ...
            >
              ...
              <DialogPrimitive.Close asChild>
                ...
                <button className='px-6 py-4 bg-black text-white border border-black group'>
